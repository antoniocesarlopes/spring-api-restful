CREATE TABLE IF NOT EXISTS `solicitation` (
	...
	INDEX `FK_SOLICITATION_OWNER` (`owner_id`) USING BTREE,
	CONSTRAINT `FK_SOLICITATION_OWNER` FOREIGN KEY (`owner_id`) REFERENCES `owner` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION
)
