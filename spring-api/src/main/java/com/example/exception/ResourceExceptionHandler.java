...
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public final ResponseEntity<ApiError> handleInvalidJwtAuthenticationExceptions(Exception ex, WebRequest request) {
		String[] parts = ex.getMessage().split(":");
		String msg = parts[parts.length - 1].trim().toUpperCase();
		
		ApiError error = new ApiError(HttpStatus.FORBIDDEN.value(), msg, new Date());
